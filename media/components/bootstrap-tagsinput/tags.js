...
class Tags {
   ...
   */
  constructor(selectElement, tagsManager, allowNew) {
  ...
  removeLastItem() {
    let items = this.containerElement.querySelectorAll("span.badge");
    if (!items.length) {
      return;
    }
  ...
  addItem(text, value) {
    ...
    span.insertAdjacentHTML('beforeend', '<span class="remove">X</span>');
